...
| Source revision | `f15b939` on `feature/profile-aware-facilitation` |
...
| M8 | passed | Exercised on the installed candidate across all three states: no generated context, matching, and skew. Skew reported: "Generated agent context still carries protocol 0.9.0 while the installed CLI provides 1.4.0". The documented remedy cleared it. |
